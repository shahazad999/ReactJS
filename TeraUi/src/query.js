...
class Query extends React.Component {
    ...
    render() {
      ...
      <Fieldset legend="Query a Medical record" legendAttrs={{ className: 'healtheintent-application' }} help="Enter a Valid Key and Click Submit" isInline style={feildStyle} >

            <Input type="text" placeholder ="ID" value={this.state.token} onChange={this.handleChange}  style={inputStyle}/>
