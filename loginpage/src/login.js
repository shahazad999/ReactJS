...
class Login extends Component {
    ...
    handleSubmit(){
        ...
        if (!(username === 'payer0' && password === 'blockchain')) {
    ...
    render() {
        ...
        if (error) {
            button =   <div>  <div style={{ border: '1px solid lightGray', backgroundColor: '#2481ca', width: '100%', height: '50px', position: 'relative' }} >
            ...
            <ApplicationMenuName
             ...
             <h3>Welcome Payer0</h3>
                <Button  onClick={this.handleLogout} text="Log Out" variant="action" style={buttonStyle2} />
         
            
                </div>
             <div  style={{position: 'absolute', paddingLeft:'500px', textAlign:'left'}}> 
           <Query />
                </div>
                </div>
        } else {
            button = <div style={{ border: '1px solid lightGray', backgroundColor: '#2481ca', width: '100%', height: '50px', position: 'relative' }} >
            <ApplicationMenuName
              title="BlockChain Web App"
              accessory={<Image variant="rounded" src={img} height="100px" width="100px" isFluid />}
            />   
            ...
            <div  style={{position: 'absolute', paddingLeft:'500px', textAlign:'left'}}> 
                ...
                <Layout header={<App/>}   style={{ margin: '3px', height: '500px', width: '500px',  position: 'relative', paddingRight: '50px' }} >
